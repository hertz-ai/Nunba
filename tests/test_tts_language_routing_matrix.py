...
# ==========================================================================
# 3. Every International Language → CosyVoice3 First
# ==========================================================================
...
@pytest.mark.parametrize('lang', INTL_LANGS)
def test_intl_lang_prefers_cosyvoice3(lang):
    prefs = _FALLBACK_LANG_ENGINE_PREFERENCE[lang]
    assert prefs[0] == BACKEND_COSYVOICE3, f"{lang} should prefer CosyVoice3"

@pytest.mark.parametrize('lang', INTL_LANGS)
def test_intl_lang_has_chatterbox_ml_fallback(lang):
    prefs = _FALLBACK_LANG_ENGINE_PREFERENCE[lang]
    assert BACKEND_CHATTERBOX_ML in prefs, f"{lang} missing Chatterbox ML fallback"
