...
<dict>
    ...
    <dict>
        <!-- ATS narrowed to localhost only.  The SPA at http://127.0.0.1:5000
             talks to the same-origin Flask + WebSocket; the rest of the
             internet stays HTTPS-required.  NSAllowsArbitraryLoads=true
             would weaken every macOS Nunba install's posture; the
             NSExceptionDomains-only form preserves the rest. -->
