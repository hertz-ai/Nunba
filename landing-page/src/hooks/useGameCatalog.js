...
// Each entry carries backend-canonical `engine` + `engine_config`
// (HARTOS integrations/social/game_catalog.py is the source of truth).
// UnifiedGameScreen resolves offline launches from these fields — never
// from category, which mislaunched games (match3 → Sudoku, every board
// game → Tic Tac Toe). Guarded by __tests__/gameEngineResolution.test.js.
export const LOCAL_CATALOG = [
  // Board Games
  {
    ...
    category: 'board',
    engine: 'boardgame',
    engine_config: {board_type: 'tictactoe'},
  ...
  },
  {
    ...
    category: 'board',
    engine: 'boardgame',
    engine_config: {board_type: 'connect4'},
  ...
  },
  {
    ...
    category: 'board',
    engine: 'boardgame',
    engine_config: {board_type: 'checkers'},
  ...
  },
  {
    ...
    category: 'board',
    engine: 'boardgame',
    engine_config: {board_type: 'reversi'},
  ...
  },
  {
    ...
    category: 'board',
    engine: 'boardgame',
    engine_config: {board_type: 'mancala'},
  ...
  },
  {
    ...
    category: 'arcade',
    engine: 'phaser',
    engine_config: {scene_id: 'breakout'},
  ...
  },
  {
    ...
    category: 'arcade',
    engine: 'phaser',
    // Registry key is underscored — passing the hyphenated id broke the scene lookup.
    engine_config: {scene_id: 'bubble_shooter'},
  ...
  },
  {
    ...
    name: 'Word Chain',
    category: 'word',
    // No client engine yet — renders the honest "coming soon" placeholder.
    engine: 'word_chain',
  ...
  },
  {
    ...
    name: 'Word Race',
    category: 'party',
    // Word racing = scramble under a tight timer; closest real engine.
    engine: 'word_scramble',
    engine_config: {round_time: 20},
