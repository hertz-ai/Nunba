...
Friend's List or other details to help you with your experience.

##When do we collect information?

We collect information from you when you are answering on our app.
...
##How AI Learning Works (HARTOS Distributed Model)

Your conversations with Nunba improve your AI experience. Here is how:

- **Local learning only**: Your AI learns and adapts on your device. Conversation context stays local.
- **No central training**: Unlike traditional AI services, no single company or entity collects your conversations to train a centralized model. Nunba follows the HARTOS distributed architecture where intelligence is decentralized.
- **You control sharing**: You decide what knowledge is shared — with everything, not just everyone. Data flows only where you explicitly permit.
- **Federated, not centralized**: When nodes in the HARTOS network connect, constitutional rules (including privacy-first) are cryptographically verified. Value drift triggers automatic disconnection.
- **No data monetization**: Your personal conversations are never sold, analyzed for advertising, or used to build profiles.

Per HARTOS constitutional rules: privacy first, local-first architecture, end-to-end encryption. Humans are always in control.
