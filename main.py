...
def _splash(msg):
    ...
    try:
        ...
        # A bare `import app` re-executes app.py's module-level code
        # (including the single-instance guard) when main.py is loaded
        # via importlib from _import_main_app(), causing SystemExit(0).
